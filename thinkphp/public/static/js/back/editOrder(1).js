var allSum = document.getElementById("allSum").innerHTML;
var orderSum = document.getElementById("orderSum").innerHTML;
...
function ShowNum(){
	...
	var num1 = document.getElementsByClassName("num")[1];
	...
	num_option.options.length = 0;	//每次加载书籍之前，先清空下拉选项
...
//	处理 原本购买 的书籍
	var preBook = document.getElementsByName("preBook")[0].value;
	if(name_value == preBook){
		for(var i = 1; i <= allSum; i++){
			var opt = document.createElement("option");
			opt.value = i;
			opt.innerHTML = i;
